...
export const ACADEMY_PAGE_CONTENT: Record<Academy, AcademyPageContent> = {
  USNA: {
    ...
    whyHeading: "A Commemorative Piece for a Defining Milestone",
    whyParagraphs: [
      "Commissioning is one of the defining moments in a midshipman's life — the transition from years of training at Annapolis into a career of service in the Fleet. Firstie Firearms creates a single commemorative piece to mark that transition, built specifically for the graduating class it represents.",
      "Each class's pistol is not a generic Naval Academy product. It is engraved with artwork, mottos, and symbols drawn from that class's own crest and traditions, so the piece speaks to the specific journey of that class rather than the Academy in general.",
    ],
    craftsmanshipHeading: "Built to Carry the Story Forward",
    craftsmanshipParagraphs: [
      "Every Naval Academy commemorative piece begins as a factory-new GLOCK 19X V. The slide is transformed through deep, multi-layer laser engraving, then hand-finished and polished before being protected with a durable Cerakote finish designed to preserve the artwork for generations.",
      "The completed pistol ships with three factory magazines and is housed in a custom two-level presentation case, with the upper level displaying the pistol and the lower level holding the included magazines in dense, closed-cell foam. Because the Naval Academy is one of three academies represented in this collection, the completed firearm still transfers through your local FFL dealer like any other class-year piece Firstie Firearms builds.",
    ],
    whoHeading: "Who the Collection Is For",
    whoParagraphs: [
      "Graduating midshipmen order their class's piece as a keepsake of commissioning. Parents and family members purchase it as a gift to mark the achievement. Naval Academy alumni from earlier classes have also used the collection to revisit the class-year piece from their own graduation, or to see what's available for the classes coming up behind them.",
      "Because each class's design is tied to that specific class, the collection also gives sponsors, mentors, and classmates a way to give a gift that is unmistakably tied to one graduate's own class rather than a general Naval Academy souvenir.",
    ],
