      ...
      {classYear === "Class of 2027" ? (
        <div className="w-full border-y border-white/10" style={{ backgroundColor: config.color }}>
          <div className="flex flex-col sm:flex-row items-stretch divide-y sm:divide-y-0 sm:divide-x divide-white/10">
            {/* Batch 1 */}
            <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-center sm:gap-10 px-6 sm:px-10 py-5 gap-2">
              <p className="font-sans text-base font-bold" style={{ color: config.gold }}>
                First Production Batch
              </p>
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline justify-between sm:justify-start gap-4">
                  <span className="text-xs font-sans uppercase tracking-wider text-white/50 w-28 sm:w-32">Order Deadline</span>
                  <span className="font-sans text-sm font-semibold text-white">November 1, 2026</span>
                </div>
                <div className="flex items-baseline justify-between sm:justify-start gap-4">
                  <span className="text-xs font-sans uppercase tracking-wider text-white/50 w-28 sm:w-32">Est. Delivery</span>
                  <span className="font-sans text-sm font-semibold text-white">December 15, 2026</span>
                </div>
              </div>
            </div>
            {/* Batch 2 */}
            <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-center sm:gap-10 px-6 sm:px-10 py-5 gap-2">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-baseline justify-between sm:justify-start gap-4">
                  <span className="text-xs font-sans uppercase tracking-wider text-white/50 w-28 sm:w-32">Order Deadline</span>
                  <span className="font-sans text-sm font-semibold text-white">April 1, 2027</span>
                </div>
                <div className="flex items-baseline justify-between sm:justify-start gap-4">
                  <span className="text-xs font-sans uppercase tracking-wider text-white/50 w-28 sm:w-32">Est. Delivery</span>
                  <span className="font-sans text-sm font-semibold text-white">May 15, 2027</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {pageTitle && (
        <section className="w-full border-b border-border px-6 py-12 md:py-16">
          <div className="max-w-3xl mx-auto space-y-6">
            <h2 className="text-2xl md:text-3xl font-bold leading-tight whitespace-nowrap overflow-visible" style={{ color: config.gold }}>
          ...
          {academy === "USNA" && classYear === "Class of 2027" ? (
            <section className="container mx-auto px-4 py-8 md:py-16 border-t border-border">
              <h2 className="text-2xl md:text-3xl font-bold text-center mb-3 md:mb-4" style={{ color: config.gold }}>
                {"USNA Class of 2027 Custom Glock 19X V"}
              </h2>
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed font-serif">
                  {"The United States Naval Academy Class of 2027 Custom Glock 19X V is more than a firearm\u2014it is a commemorative heirloom created to honor one of life's greatest achievements: earning a commission as an officer in the United States Navy or Marine Corps."}
                </p>
                <p className="text-sm md:text-base text-muted-foreground leading-relaxed font-serif">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed font-serif">
                    {"The top of the slide celebrates the Naval Academy itself. A trident symbolizes sea power and maritime leadership, while the dove and Polaris star\u2014drawn directly from the Class of 2027 crest\u2014represent guidance, purpose, and service. A banner proudly bearing CLASS OF 2027 commemorates the class's transition from midshipmen to commissioned officers."}
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-sm md:text-base text-muted-foreground leading-relaxed font-serif">
                    {"Whether purchased for a graduating midshipman, proud parent, family member, sponsor, or mentor, the USNA Class of 2027 Custom Glock 19X V stands as a lasting tribute to sacrifice, achievement, and the beginning of a career dedicated to serving the nation."}
                  </p>
                </div>
