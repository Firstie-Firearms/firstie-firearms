      ...
      <section className="container mx-auto px-4 py-8 md:py-16">
        <div className="max-w-3xl mx-auto space-y-8 md:space-y-12">
          ...
          <div className="space-y-4 md:space-y-6 pt-6 md:pt-8 border-t border-border">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed font-serif">
              {"We are committed to preserving the traditions and values of the United States Military Academy, United States Naval Academy, and United States Air Force Academy through our work. Through class year personalization and individually numbered engravings, we ensure that every firearm remains exclusive and meaningful. Firstie Firearms is more than a company—it is a tribute to the Long Gray Line, the Fleet, and the Wild Blue Yonder."}
            </p>
          </div>
        </div>
      </section>
